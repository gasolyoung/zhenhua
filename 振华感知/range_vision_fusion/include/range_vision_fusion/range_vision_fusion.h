...
class ROSRangeVisionFusionApp
{
  ...
  ros::Publisher publisher_trash_objects_;
  ...
  ros::Subscriber plane_coeff_subscriber_;

  // message_filters::Subscriber<autoware_msgs::DetectedObjectArray>
  //   *vision_filter_subscriber_, *range_filter_subscriber_;
  
  message_filters::Subscriber<autoware_msgs::DetectedObjectArray> *vision_filter_subscriber_;
    
  message_filters::Subscriber<autoware_msgs::CloudClusterArray> *range_filter_subscriber_;
  ...
  autoware_msgs::CloudClusterArray::ConstPtr range_detections_;
  ...
  bool plane_coeff_ok_;
  bool use_mono_estimate;

  // ljc add:
  std::vector<float> plane_coeff;
  int left_ignort_line_, right_ignore_line_, bottom_emergency_line_;
  ...
  void CheckMinimumDimensions(autoware_msgs::CloudCluster &in_out_object);
  ...
  void RangeDetectionsCallback(const autoware_msgs::CloudClusterArray::ConstPtr &in_cloud_msg);
  ...
  tf::Vector3 ProjectPoint(const cv::Point2i &in_point);

  // cv::Rect ProjectDetectionToRect(const autoware_msgs::DetectedObject &in_detection);
  cv::Rect ProjectDetectionToRect(const autoware_msgs::CloudCluster &in_detection);

  // bool IsObjectInImage(const autoware_msgs::DetectedObject &in_detection);
  bool IsObjectInImage(const autoware_msgs::CloudCluster &in_detection);
  ...
  void TransformRangeToVision(const autoware_msgs::CloudClusterArray::ConstPtr &in_range_detections,
                              autoware_msgs::CloudClusterArray &out_range_detections,
  ...
  double GetDistanceToObject(const autoware_msgs::CloudCluster &in_object);
  ...
  void PlaneCoeffCallback(const std_msgs::Float32MultiArrayConstPtr &in_message);
